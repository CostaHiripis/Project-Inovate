          ...
          children: <Widget>[
            Column(
              children: <Widget>[
                AspectRatio(
                    aspectRatio: 1.2,
                    child: Image(image: AssetImage('images/keanu.png'))),
              ],
            ),
            Positioned(
                          ...
                          AnimatedOpacity(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: <Widget>[
                                  getTimeBoxUI('Day Of \n Event',
                                      this.widget.passedDayOfEvent),
                                  getTimeBoxUI('Completed in',
                                      this.widget.timeToComplete.toString()),
                                  getTimeBoxUI(
                                      'Rating', this.widget.rating.toString()),
                                ],
                              ),
                            ),
                          ),
